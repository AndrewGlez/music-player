            ...
            <table className="w-full select-none">
              ...
              <tbody className="text-sm">
                {playlist?.tracks.map((track, i) => (
                  <tr key={i} className="group hover:bg-white/10 select-none rounded">
                    ...
                    <ContextMenu>
                      <ContextMenuTrigger>
                        <td className="px-4 py-2">
                          <div className="flex text-neutral-400 hover:text-white items-center gap-3">
                            ...
                            <div>
                              <div onClick={() => handleSongClick(track)}>{track.title}</div>
                            </div>
                          </div>
                        </td>
                      </ContextMenuTrigger>
                      <ContextMenuContent>
                        <ContextMenuItem
                          onClick={() => handleDeleteSong(playlist.id, track.id)}
