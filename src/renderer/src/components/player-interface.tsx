...
export default function PlayerInterface() {
  ...
  return (
    <div
      className={`bg-cover area circles bg-indigo-950 text-white w-full fixed bottom-0 left-0 right-0`}
    >
      <li></li>
      <li></li>
      <li></li>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex flex-col items-center w-1/2 mx-10">
            ...
            <div className="w-full">
              ...
              <div className="select-none flex justify-between text-xs mt-1">
